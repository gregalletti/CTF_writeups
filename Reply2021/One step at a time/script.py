...
ex_maze = example_parts[0]
ex_map = example_parts[1]
ex_letter = example_parts[2]

ex_map_parts = ex_map.split("\n")

ex_map_start = ex_map_parts[1]
ex_map_end  = ex_map_parts[5]

ex_coded_letter = ex_maze[ex_maze.find(ex_map_start):ex_maze.find(ex_map_end)]
...
'''
	...
	print('{:>100}'.format(coded_letter[0]))

	for row in coded_letter[1:]:
		print(row)
'''
